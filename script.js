const translations = {
    ...
    focus: {
      ...
      rows: {
        infrastructure: {
          ...
          meta: 'Procurement / Supply'
        },
        energy: {
          title: 'Energy & utility solutions',
          meta: 'Projects / Equipment'
        },
        medical: {
          title: 'Medical & laboratory supply',
          meta: 'Equipment / Consumables'
        },
        specialized: {
  ...
  ar: {
    meta: {
      title: 'TOLVANO — استكشاف فرص الأعمال وربط الموردين',
      description: 'تعمل TOLVANO كشريك في استكشاف فرص الأعمال وربط الموردين بالمشترين. نوضح متطلبات الشراء، ونقيّم مدى ملاءمة المورد للاحتياج، ثم نفتح حوارًا تجاريًا مباشرًا بين الأطراف المناسبة.',
      ogTitle: 'TOLVANO — استكشاف فرص الأعمال وربط الموردين',
      ogDescription: 'متطلبات واضحة، وتقييم ملاءمة المورد، وحوار تجاري مباشر بين الأطراف المناسبة.',
      locale: 'ar_AR',
      language: 'ar',
    ...
    brand: {
      home: 'الصفحة الرئيسية لـ TOLVANO'
    },
    navigation: {
      primary: 'التنقل الرئيسي',
      capabilities: 'ما نقدمه',
      approach: 'كيف نعمل',
      focus: 'مجالات التركيز',
      contact: 'ابدأ حوارًا تجاريًا'
    },
    language: {
      selector: 'اختيار اللغة'
    },
    emailSubjects: {
      header: 'حوار تجاري مع TOLVANO',
      opportunity: 'متطلبات أو فرصة تجارية مع TOLVANO',
      footer: 'حوار تجاري مع TOLVANO',
      mobile: 'حوار تجاري مع TOLVANO'
    },
    hero: {
      eyebrow: 'استكشاف فرص الأعمال وربط الموردين بالمشترين',
      title: 'احتياج واضح.<br /><span>توريد مناسب.</span><br />حوار تجاري مباشر.',
      lead: 'تعمل TOLVANO كشريك في استكشاف فرص الأعمال وربط الموردين بالمشترين. نوضح متطلبات الشراء، ونقيّم مدى ملاءمة المورد للاحتياج، ثم نفتح حوارًا تجاريًا مباشرًا بين الأطراف المناسبة.',
      primaryCta: 'شاركنا متطلباتك أو قدراتك',
      secondaryCta: 'تعرّف إلى آلية عمل TOLVANO',
      principles: 'منهج عمل TOLVANO',
      principleOne: 'متطلبات واضحة',
      principleTwo: 'تقييم ملاءمة المورد',
      principleThree: 'تواصل تجاري مباشر'
    },
    visual: {
      signal: 'TOLVANO / خريطة الفرصة',
      status: 'مركّز',
      qualify: 'تقييم',
      relevance: 'وضوح الاحتياج',
      align: 'مواءمة',
      capability: 'ملاءمة المورد',
      intelligence: 'ربط تجاري',
    ...
    statement: {
      kicker: 'لسنا دليلًا للشركات، ولا منصة للمراسلات الجماعية.',
      title: 'تعمل TOLVANO كشريك في استكشاف الفرص وربط الموردين بالمشترين. نوضح الاحتياج، ونقيّم مدى ملاءمة المورد، ثم نفتح حوارًا تجاريًا مباشرًا بين الأطراف المناسبة.'
    },
    capabilities: {
      kicker: 'منهج واضح لبدء حوار تجاري بين الأطراف المناسبة',
      title: 'من احتياج واضح إلى حوار تجاري مباشر.',
      cards: {
        sourcing: {
          title: 'استكشاف الفرص',
          body: 'نستكشف احتياجات شراء وفرصًا تجارية واضحة، حين تتوافق المتطلبات والتوقيت وإمكانات التوريد.',
          link: 'حدّد الفرصة'
        },
        fit: {
          title: 'تقييم ملاءمة المورد',
          body: 'نقيّم المنتج، وقدرة المورد على التنفيذ، والنطاق الجغرافي، والاستعداد للتعامل التجاري قبل بدء التواصل.',
          link: 'قيّم الملاءمة'
        },
        introductions: {
          title: 'ربط تجاري بين الشركات',
          body: 'عند توافر توافق حقيقي، نيسّر تواصلاً مباشرًا بين الأطراف المناسبة، يركّز على القرار التجاري.',
          link: 'ابدأ الحوار'
        }
      }
    },
    approach: {
      kicker: 'مسار تجاري واضح',
      title: 'نوضح الاحتياج، ثم نقيّم ملاءمة المورد، وبعدها نفتح الحوار التجاري.',
      steps: {
        qualify: {
          title: 'توضيح المتطلبات التجارية',
          body: 'الاحتياج الشرائي، والنطاق، والتوقيت، وسياق المشتري، والجدوى التجارية.'
        },
        map: {
          title: 'تقييم ملاءمة المورد',
          body: 'ملاءمة المنتج، وقدرة المورد، والنطاق الجغرافي، وواقعية التنفيذ.'
        },
        open: {
          title: 'فتح حوار تجاري مباشر',
          body: 'نيسّر تواصلاً أوليًا موجزًا بين الأطراف الأنسب لبدء الحوار.'
        },
        advance: {
          title: 'تحديد الخطوة التالية',
          body: 'يبقى الحوار موجّهًا إلى الخطوة العملية التالية في القرار التجاري.'
        }
      }
    },
    focus: {
      kicker: 'مجالات يكون فيها التوقيت وملاءمة التوريد حاسمين',
      title: 'توريد معقد. متطلبات واضحة.',
      rows: {
        infrastructure: {
        ...
        energy: {
          title: 'حلول الطاقة والمرافق',
          meta: 'مشاريع / معدات'
        },
        medical: {
          title: 'المستلزمات الطبية والمخبرية',
          meta: 'معدات / مستهلكات'
        },
        specialized: {
          title: 'استكشاف الفرص المتخصصة بين الشركات',
          meta: 'متطلبات واضحة / حسب الحاجة'
        }
      }
    },
    basis: {
      label: 'أساس عمل TOLVANO',
      kicker: 'نقطة انطلاق واضحة لحوار تجاري جاد',
      title: 'نطاق واضح. توافق حقيقي. تواصل مباشر.',
      items: {
        remit: {
          title: 'نطاق العمل',
          body: 'استكشاف الفرص، وتقييم مدى ملاءمة المورد، وتيسير التواصل المباشر بين الشركات.'
        },
        start: {
          title: 'نقطة انطلاق واضحة',
          body: 'احتياج شرائي واضح أو قدرة توريد واقعية يمنحان الحوار اتجاهًا عمليًا.'
        },
        contact: {
          title: 'تواصل تجاري مباشر',
          body: 'يمثل بريد TOLVANO التجاري نقطة البداية لأي حوار تجاري.'
        }
      }
    },
    cta: {
      kicker: 'أي حوار مثمر يبدأ بمتطلبات واضحة.',
      title: 'لديك احتياج شرائي أو قدرة توريد؟<br /><span>لنبدأ بتحديد مدى ملاءمة الفرصة.</span>',
      emailCta: 'ابدأ عبر البريد',
      body: 'للموردين أصحاب قدرات توريد ملائمة، وللمشترين ذوي متطلبات واضحة، وللجهات التي لديها احتياجات توريد محددة.'
    },
    contact: {
      copyPrompt: 'هل تفضّل استخدام بريدك المعتاد؟ انسخ العنوان مباشرة.',
      copyAction: 'نسخ العنوان',
      copyAria: 'نسخ عنوان بريد TOLVANO',
      copySuccess: 'تم نسخ العنوان.',
      copyFallback: 'تم تحديد العنوان؛ انسخه من المتصفح.'
    },
    mobileCta: {
      label: 'ابدأ حوارًا تجاريًا',
      action: 'ابدأ حوارًا تجاريًا'
    },
    footer: {
      description: 'استكشاف فرص الأعمال وربط الموردين بالمشترين.',
...
function updateMenuToggleLabel() {
  ...
  const labelKey = isOpen ? 'meta.menuClose' : 'meta.menuOpen';
...
function applyLanguage(language, { announce = false, updateUrl = false } = {}) {
  ...
  document.querySelectorAll('[data-i18n-mailto]').forEach((element) => {
    const subject = getTranslation(language, element.dataset.i18nMailto);
    const email = element.dataset.mailtoEmail;
  ...
  setMetaContent(meta.description, getTranslation(language, 'meta.description'));
  setMetaContent(meta.language, getTranslation(language, 'meta.language'));
...
const finalCtaSection = document.querySelector('.cta-section');
if (mobileCta && finalCtaSection && 'IntersectionObserver' in window) {
  const mobileCtaObserver = new IntersectionObserver((entries) => {
    document.body.classList.toggle('final-cta-visible', entries.some((entry) => entry.isIntersecting));
  }, { threshold: 0.18 });
  mobileCtaObserver.observe(finalCtaSection);
}
...
if (glow && window.matchMedia && window.matchMedia('(pointer:fine)').matches && !prefersReducedMotion) {
